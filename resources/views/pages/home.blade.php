            ...
            <div class="space-y-2.5">
                ...
                <div class="grid grid-cols-1 gap-2.5 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_9.5rem_auto]">
                    ...
                    <div class="relative" data-multiselect>
                        ...
                        <div class="absolute right-0 top-[calc(100%+0.35rem)] z-30 hidden w-full rounded-lg border border-secondary/20 bg-white p-1.5 text-left shadow-card md:w-44" data-multiselect-panel>
