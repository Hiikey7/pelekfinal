        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex items-center gap-3 mt-4">
              {settings.instagram && (
                <a href={settings.instagram} target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity" aria-label="Instagram">
              ...
              {settings.tiktok && (
                <a href={settings.tiktok} target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity" aria-label="TikTok">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm opacity-80">
              ...
              <a href={`https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}`} className="flex items-center gap-2 hover:opacity-100 transition-opacity">
